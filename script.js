// Datos de cursos: id, nombre, créditos, semestre y prerrequisitos
const courses = [
  ...
  { id:'CEL1', name:'Compr. y Exp. Lingüística I', credits:3, sem:1, prereqs:[] },
  ...
  { id:'EGA', name:'Epid. gen. y saneam. amb.', credits:3, sem:6, prereqs:['ES'] },
...
// Desbloquear cursos según prerrequisitos
...
function updateAverage() {
  ...
  averageEl.innerText = `Promedio: ${avg.toFixed(2)}`;
}

// Dibujar flechas entre caja y sus dependientes
function drawArrows() {
